...
namespace std {
  ...
  public:
    ...
    friend constexpr @\exposid{synth-three-way-result}@<T> operator<=>(reference_wrapper, reference_wrapper);
    friend constexpr @\exposid{synth-three-way-result}@<T> operator<=>(reference_wrapper, const T&);
    friend constexpr @\exposid{synth-three-way-result}@<T> operator<=>(reference_wrapper,
...
\begin{itemdecl}
friend constexpr @\exposid{synth-three-way-result}@<T> operator<=>(reference_wrapper x, reference_wrapper y);
\end{itemdecl}
...
\begin{itemdecl}
friend constexpr @\exposid{synth-three-way-result}@<T> operator<=>(reference_wrapper x, const T& y);
\end{itemdecl}
...
\begin{itemdecl}
friend constexpr @\exposid{synth-three-way-result}@<T> operator<=>(reference_wrapper x,
